...
logger.automataLR(ab, 'ab', false);

var automata = AO.operations.sequentialDeletionFA(new AO.automata.FA(abaababORbabORc), new AO.automata.FA(ab));
logger.accepts(automata,'b');
logger.accepts(automata,'aabab');
logger.accepts(automata,'abaab');
console.log('----');
